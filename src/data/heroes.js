export const heroes = [
  ...
  },
  {
    ...
    biography: {
      fullName: '',
      alterEgos: 'No alter egos found.',
      aliases: ['Professor Ivos Amazing Android'],
      placeOfBirth: '-',
  ...
  },
  {
    ...
    connections: {
      groupAffiliation: '-',
      relatives:
        'Niki Sanders (Mother), DL Hawkins (Father), Paulette Hawkins (paternal grandmother), Hal Sanders (maternal grandfather), Nana Dawson (Guardian) Nana Dawson (Great-aunt), Monica Dawson (Cousin), Damon Dawson (Cousin)',
    },
    images: {
      xs:
  ...
  },
  {
    ...
    connections: {
      ...
      relatives:
        'Jack Fury (father, deceased); unnamed mother; unnamed stepmother (deceased); Dawn Fury (half-sister); Jake Fury (half-brother); Mikel Fury (son, deceased); Jerry Sapristi (cousin); Tina Sapristi (cousin by marriage); Ernesto, Pietro, Giovanni, Maria, Rosa and Gabriella (1st cousins once removed);',
    },
    images: {
      xs:
  ...
  },
  {
    ...
    connections: {
      ...
      relatives:
        "Talia al Ghul (mother), Bruce Wayne (Batman, father), Ra's Al Ghul (maternal grandfather), Melisande (maternal grandmother), Thomas Wayne (paternal grandfather), Martha Wayne (paternal grandmother), Sensei (great-grandfather), Simon Hurt (ancestor), Nyssa Raatko (aunt, deceased), Dusan al Ghul (White Ghost, uncle, deceased), Richard Grayson (Nightwing, adoptive brother), Tim Drake (Red Robin, adoptive brother), Cassandra Cain (Batgirl IV, adoptive sister), Jason Todd (Red Hood, adoptive brother), Patrick Wayne (great-grandfather, deceased); Charles Wayne (great-great-grandfather, deceased); Constance Wayne (great-great-grandmother, deceased); Alan Wayne (ancestor, deceased); Solomon Wayne (ancestor, deceased); Darius Wayne (ancestor, deceased); Joshua Wayne (ancestor, deceased)",
    },
    images: {
      xs:
